  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'dark-glass-gradient': 'linear-gradient(135deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.1) 100%)',
        'neon-gradient': 'linear-gradient(90deg, #00f3ff, #9d00ff, #ff00ff)',
      ...
      boxShadow: {
        ...
        'neon-lg': '0 0 40px rgba(0, 243, 255, 0.8)',
        'spatial': '0 20px 60px rgba(0, 0, 0, 0.3), 0 0 0 1px rgba(255, 255, 255, 0.1)',
      },
    },
  },
  plugins: [
